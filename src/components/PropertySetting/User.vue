  ...
  <div>
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="User Role">
        <el-select v-model="form.region" placeholder="Select a user role">
          <el-option label="Field Technician" value="field-technician"></el-option>
          <el-option label="Contractor" value="contractor"></el-option>
          <el-option label="Manager" value="manager"></el-option>
          <el-option label="Admin" value="admin"></el-option>
          <el-option label="HR" value="hr"></el-option>
          <el-option label="QHSE Rep" value="qhse-rep"></el-option>
        </el-select>
      </el-form-item>
